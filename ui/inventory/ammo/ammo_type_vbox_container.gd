...
const AMMO_SUBTYPE_H_BOX = preload("res://ui/inventory/ammo/ammo_subtype_h_box.tscn")
...
func _ready() -> void:
	...
	for subtype:AmmoSubtype in ammo_type.sub_types:
		var subtype_control:AmmoSubtypeHBoxControl = AMMO_SUBTYPE_H_BOX.instantiate()
